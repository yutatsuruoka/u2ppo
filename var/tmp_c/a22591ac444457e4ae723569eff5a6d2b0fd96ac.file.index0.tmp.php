...
<section id="question01" class="wrapper mgb100">
    ...
    <p class="font24 lineheight150">
        ...
        しかし、直接はとても言いづらい。<br>
        そんな場合には、うつっぽを使って間接的に通知を送ってみましょう。
    </p>
</section>

<section id="hatena01" class="wrapper mgb100">
    <header class="mgb30 clearfix">
        <div class="iconBlock pull-left">
            <img src="i/icon_hatena.png" alt="">
        </div>
        <div class="textBlock pull-right">
            <h1 class="mgt10 mgb15 font24 color">うつっぽの使い方</h1>
            <p>うつっぽは非常に簡単に、そして匿名性を活かしてうつ予備軍の通知を行えます。<br>
                うつ病になる前に大切な人へしっかりと通知をし、手遅れとなる前にレベルに合わせた対処法を呼びかけます。</p>
        </div>
    </header>
    <ul class="thumbContainer mgb50">
        <li><img src="i/hatena_img01.png" alt="">通知したい相手の情報を入力</li>
        <li><img src="i/hatena_img02.png" alt="">アンケートが相手に届きます</li>
        <li><img src="i/hatena_img03.png" alt="">いくつかの質問に答えると…</li>
        <li class="last"><img src="i/hatena_img04.png" alt="">結果に基づいた対処法をアドバイス</li>
    </ul>
</section>
